...
RQ_LOCATION_REQUIRE = 'Для поиска доноров нам также нужно знать геопозицию места кроводачи.\n' \
                      'Обратите внимание, данная геопозиция должна быть *максимально* точной.\n' \
...
RQ_LOCATION_REPLY = 'Геопозиция кроводачи:'
# endregion
