...
GEO_INFO = 'Обратите внимание, данная геопозиция должна быть *максимально* точной.\n' \
       ...
       '2) Отправить метку на карте в ответ на (ВНИМАНИЕ ЭТО ВАЖНО!) *последнее* сообщение бота.'
# endregion
...
RQ_GEO_REQUIRE = 'Для поиска доноров нам также нужно знать геопозицию места сдачи крови.\n' + GEO_INFO
